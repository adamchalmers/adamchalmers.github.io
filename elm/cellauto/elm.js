...
var _user$project$GameOfLife$pickleCell = function (cell) {
	var _p0 = cell;
	if (_p0.ctor === 'Live') {
		return 'L';
	} else {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 20, _1: 11},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 20, _1: 12},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 20, _1: 13},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 9, _1: 19},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 10, _1: 20},
												_1: {
													ctor: '::',
...
var _user$project$Grid$headOfTail = function (_p0) {
	return A2(
		_elm_lang$core$Maybe$andThen,
		_elm_lang$core$List$head,
		_elm_lang$core$List$tail(_p0));
};
var _user$project$Grid$row = F2(
	function (i, grid) {
	...
	var shrunkRows = A2(
		...
		function (arr) {
			return A3(
				...
				0,
				-1 + _elm_lang$core$Array$length(arr),
				arr);
		},
		g);
	return A3(
		_elm_lang$core$Array$slice,
		0,
		-1 + _elm_lang$core$Array$length(g),
		shrunkRows);
};
var _user$project$Grid$incSize = F2(
	function (val, g) {
		var newRow = A2(
			_elm_lang$core$Array$initialize,
			1 + _elm_lang$core$Array$length(g),
		...
		var grownRows = A2(
			_elm_lang$core$Array$map,
			function (row) {
				return A2(_elm_lang$core$Array$push, val, row);
			},
			g);
		return A2(_elm_lang$core$Array$push, newRow, grownRows);
	});
var _user$project$Grid$set = F3(
	function (_p1, val, grid) {
		var _p2 = _p1;
		var _p4 = _p2._1;
		var _p3 = A2(_elm_lang$core$Array$get, _p4, grid);
		if (_p3.ctor === 'Just') {
			return A3(
				_elm_lang$core$Array$set,
				_p4,
				A3(_elm_lang$core$Array$set, _p2._0, val, _p3._0),
				grid);
		} else {
			return grid;
		}
...
var _user$project$Grid$get = F2(
	function (_p5, grid) {
		...
		return A2(
			...
			A2(_elm_lang$core$Array$get, _p6._1, grid));
	});
	...
	function (_p8, g) {
		...
		var cands = {
			...
			_0: A2(
				...
				{ctor: '_Tuple2', _0: _p10 + 1, _1: _p11},
				g),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					...
					_0: A2(
						_user$project$Grid$get,
						{ctor: '_Tuple2', _0: _p10, _1: _p11 + 1},
						g),
					_1: {
						ctor: '::',
						_0: A2(
						...
						_1: {
							...
							_0: A2(
								_user$project$Grid$get,
								{ctor: '_Tuple2', _0: _p10 + 1, _1: _p11 + 1},
								g),
							_1: {
								ctor: '::',
								_0: A2(
		...
		return A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, cands);
	});
var _user$project$Grid$neighboursNoDiags = F2(
	function (_p12, g) {
		var _p13 = _p12;
		var _p15 = _p13._0;
		var _p14 = _p13._1;
		var cands = {
			...
			_0: A2(
				_user$project$Grid$get,
				{ctor: '_Tuple2', _0: _p14 + 1, _1: _p15},
				g),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					...
					_0: A2(
						_user$project$Grid$get,
						{ctor: '_Tuple2', _0: _p14, _1: _p15 + 1},
						g),
					_1: {
						ctor: '::',
						_0: A2(
...
var _user$project$Grid$toLists = function (g) {
	return _elm_lang$core$Array$toList(
		A2(_elm_lang$core$Array$map, _elm_lang$core$Array$toList, g));
};
var _user$project$Grid$flatten = function (g) {
	return _elm_lang$core$List$concat(
		_user$project$Grid$toLists(g));
};
var _user$project$Grid$fromLists = function (ls) {
	return _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$List$map, _elm_lang$core$Array$fromList, ls));
};
...
var _user$project$Grid$initAs = F3(
	function (f, w, h) {
		return A2(
			_elm_lang$core$Array$initialize,
			w,
...
var _user$project$Grid$init = F3(
	function (val, w, h) {
		return A2(
			_elm_lang$core$Array$initialize,
			w,
...
var _user$project$Grid$height = function (g) {
	var _p16 = A2(_elm_lang$core$Array$get, 0, g);
	if (_p16.ctor === 'Nothing') {
		...
		return _elm_lang$core$Array$length(_p16._0);
	}
};
var _user$project$Grid$length = _elm_lang$core$Array$length;
var _user$project$Grid$transpose = function (grid) {
	var r = A2(
		_elm_lang$core$List$range,
		0,
		-1 + _user$project$Grid$length(grid));
	return _elm_lang$core$Array$fromList(
		A2(
			_elm_lang$core$List$map,
			function (i) {
				return A2(_user$project$Grid$row, i, grid);
			},
			r));
};
var _user$project$Grid$_p18 = {ctor: '_Tuple3', _0: '#!#', _1: ',', _2: ':'};
var _user$project$Grid$mainDelimiter = _user$project$Grid$_p18._0;
var _user$project$Grid$cellDelimiter = _user$project$Grid$_p18._1;
var _user$project$Grid$indxDelimiter = _user$project$Grid$_p18._2;
var _user$project$Grid$pickle = F2(
	function (f, g) {
		var len = _elm_lang$core$Basics$toString(
		...
		var contents = A2(
			...
			_user$project$Grid$cellDelimiter,
			_elm_lang$core$List$concat(
				_user$project$Grid$toLists(
					A2(_user$project$Grid$indexedMap, serialise, g))));
		return _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: len,
				_1: {ctor: '::', _0: _user$project$Grid$mainDelimiter, _1: contents}
			});
	});
var _user$project$Grid$unpickle = F3(
	function (val, unpickler, s) {
		var lookupIndex = F3(
			function (d, _p21, cell) {
				var _p22 = _p21;
				return A2(
		...
		var toTuples = function (_p23) {
			return A2(
				_elm_lang$core$List$filterMap,
				function (_p24) {
					var _p25 = _p24;
					var _p26 = {ctor: '_Tuple2', _0: _p25._0._0, _1: _p25._0._1};
					if (((_p26.ctor === '_Tuple2') && (_p26._0.ctor === 'Ok')) && (_p26._1.ctor === 'Ok')) {
						return _elm_lang$core$Maybe$Just(
							{
								ctor: '_Tuple2',
								_0: {ctor: '_Tuple2', _0: _p26._0._0, _1: _p26._1._0},
								_1: unpickler(_p25._1)
							});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				...
				A2(
					...
					A2(
						...
						function (l) {
							var _p27 = l;
							if ((((_p27.ctor === '::') && (_p27._1.ctor === '::')) && (_p27._1._1.ctor === '::')) && (_p27._1._1._1.ctor === '[]')) {
								return _elm_lang$core$Maybe$Just(
									{
										ctor: '_Tuple2',
										_0: {
											ctor: '_Tuple2',
											_0: _elm_lang$core$String$toInt(_p27._0),
											_1: _elm_lang$core$String$toInt(_p27._1._0)
										},
										_1: _p27._1._1._0
									});
							} else {
		...
		var splitter = function (_p28) {
			return A2(
				_elm_lang$core$List$map,
				_elm_lang$core$String$split(_user$project$Grid$indxDelimiter),
				A2(_elm_lang$core$String$split, _user$project$Grid$cellDelimiter, _p28));
		};
		var dict = A2(
		...
		var stubGrid = A2(
			_elm_lang$core$Result$map,
			function (n) {
				return A3(_user$project$Grid$init, val, n, n);
			},
			A2(
			...
			case 'Play':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: {play: _user$project$Main$Playing, boardCode: model.state.boardCode}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Pause':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: {play: _user$project$Main$Paused, boardCode: model.state.boardCode}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Stop':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: {play: _user$project$Main$Stopped, boardCode: model.state.boardCode},
							...
							model,
							{
								cellgrid: A2(
									...
									F2(
										function (index, c) {
											return A2(
												_user$project$GameOfLife$evolveCell,
												c,
												A2(_user$project$Grid$neighbours, index, model.cellgrid));
										}),
									model.cellgrid),
				...
				if (_p2.ctor === 'Stopped') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								cellgrid: A3(
									_user$project$Grid$mutate,
									{ctor: '_Tuple2', _0: _p3, _1: _p4},
									_user$project$GameOfLife$onClick,
									model.cellgrid),
								startGrid: A3(
									_user$project$Grid$mutate,
									{ctor: '_Tuple2', _0: _p3, _1: _p4},
				...
				if (_p5.ctor === 'Stopped') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								cellgrid: A2(_user$project$Grid$incSize, _user$project$GameOfLife$defaultCell, model.cellgrid),
								startGrid: A2(_user$project$Grid$incSize, _user$project$GameOfLife$defaultCell, model.cellgrid)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p6.ctor === 'Stopped') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								cellgrid: _user$project$Grid$decSize(model.cellgrid),
								startGrid: _user$project$Grid$decSize(model.cellgrid)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p7.ctor === 'Stopped') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								cellgrid: A3(
									_user$project$Grid$init,
									_user$project$GameOfLife$defaultCell,
									_user$project$Grid$length(model.startGrid),
									_user$project$Grid$length(model.startGrid)),
								startGrid: A3(
									_user$project$Grid$init,
									_user$project$GameOfLife$defaultCell,
			...
			case 'ToggleBoardCode':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: {boardCode: !model.state.boardCode, play: model.state.play}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LoadBoard':
...
var _user$project$Main$IncSize = {ctor: 'IncSize'};
...
var _user$project$Main$buttonsFor = function (m) {
	...
	var minus = A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$DecSize),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	var plus = A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$IncSize),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				_elm_lang$html$Html$td,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$class(
							_user$project$GameOfLife$cssClass(cell)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'});
