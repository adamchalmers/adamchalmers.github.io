...
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{rendered: '', screenplay: flags, serverMessage: ''},
...
var author$project$Main$RenderResponse = function (a) {
	return {$: 'RenderResponse', a: a};
};
...
var author$project$Main$postScreenplay = function (s) {
	return elm$http$Http$post(
		{
			...
			expect: elm$http$Http$expectString(author$project$Main$RenderResponse),
	...
	function (message, model) {
		switch (message.$) {
			...
			case 'RenderBtnPress':
				return _Utils_Tuple2(
					model,
					author$project$Main$postScreenplay(model.screenplay));
			case 'TestServer':
				var expect = A2(
...
var author$project$Main$ChangeScreenplay = function (a) {
	return {$: 'ChangeScreenplay', a: a};
};
var author$project$Main$RenderBtnPress = {$: 'RenderBtnPress'};
...
var author$project$Main$rendersOf = function (model) {
	var _n0 = hecrj$html_parser$Html$Parser$run(model.rendered);
	if (_n0.$ === 'Ok') {
		var html = _n0.a;
		return hecrj$html_parser$Html$Parser$Util$toVirtualDom(html);
	} else {
		var err = _n0.a;
		return _List_fromArray(
			[
				elm$html$Html$text('Render error')
			]);
	}
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Fountain-rs live demo')
							]))
					])),
				A2(
				elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onInput(author$project$Main$ChangeScreenplay),
										elm$html$Html$Attributes$cols(40),
										elm$html$Html$Attributes$rows(20)
									]),
								_List_fromArray(
									[
										elm$html$Html$text(model.screenplay)
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onClick(author$project$Main$RenderBtnPress)
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								author$project$Main$rendersOf(model))
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href('https://fountain.io/'),
								elm$html$Html$Attributes$target('_blank')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('New to Fountain?')
							]))
					]))
			]));
};
